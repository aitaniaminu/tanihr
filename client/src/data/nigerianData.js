...
export const nigerianStates = [
  ...
  { name: 'Akwa Ibom', lgas: ['Abak', 'Eastern Obolo', 'Eket', 'Esit Eket', 'Essien Udim', 'Etim Ekpo', 'Etinan', 'Ibeno', 'Ibesikpo Asutan', 'Ibiono Ibom', 'Ika', 'Ikono', 'Ikot Abasi', 'Ikot Ekpene', 'Ini', 'Itu', 'Mbo', 'Mkpat Enin', 'Nsit Atai', 'Nsit Ubium', 'Nsit Ibum', 'Obot Akara', 'Okobo', 'Onna', 'Oron', 'Oruk Anam', 'Udung Uko', 'Ukanafun', 'Uruan', 'Urue Offong Oruko', 'Uyo'] },
  ...
  { name: 'FCT', lgas: ['Abaji', 'Bwari', 'Gwagwalada', 'Kuje', 'Kwali', 'Abuja Municipal Area Council'] },
  ...
  { name: 'Osun', lgas: ['Atakunmosa East', 'Atakunmosa West', 'Aiyedaade', 'Aiyedire', 'Boluwaduro', 'Boripe', 'Ede North', 'Ede South', 'Egbedore', 'Ejigbo', 'Ife Central', 'Ife East', 'Ife North', 'Ife South', 'Ifedayo', 'Ifelodun', 'Ila', 'Ilesha East', 'Ilesha West', 'Irepodun', 'Irewole', 'Isokan', 'Iwo', 'Obokun', 'Odo Otin', 'Ola Oluwa', 'Olorunda', 'Oriade', 'Orolu', 'Osogbo'] },
...
export const defaultPFAs = [
  'Leadway Pensure',
  'Stanbic IBTC Pension Managers',
  'ARM Pension Managers',
  'Access Pension Fund',
  'AIICO Pension Managers',
  'Cornerstone Pension Fund',
  'Crusader Sterling Pension Fund',
  'Fidelity Pension Managers',
  'First Pension Custodian',
  'FCMB Pension Fund',
  'Guinea Trust Pension Fund',
  'Heritage Pension Fund',
  'JAIZ Pension Fund',
  'Mainstreet Pension Fund',
  'Mutual Benefits Pension Fund',
  'NPF Pension Fund',
  'Nova Pension Fund',
  'Omega Pension Fund',
  'Pencom Pension Fund',
  'Prestige Pension Fund',
  'Proshare Pension Fund',
  'Radix Pension Fund',
  'Regency Alliance Pension Fund',
  'Reliance Pension Fund',
  'Sovereign Pension Fund',
  'Stableton Pension Fund',
  'SunTrust Pension Fund',
  'Union Pension Fund',
  'Veritas Pension Fund',
  'Zenith Pension Fund'
];
...
export function getGeoPoliticalZone(stateName) {
  return geopoliticalZones[stateName] || '';
}
